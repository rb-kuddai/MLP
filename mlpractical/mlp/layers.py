...
class Sigmoid(Linear):
    ...
    def bprop(self, h, igrads, first_layer=False):
        dsigm = h * (1.0 - h)
        deltas = igrads * dsigm
        ___, ograds = super(Sigmoid, self).bprop(h=None, igrads=deltas, first_layer=first_layer)
...
class Relu(Linear):
    ...
    def bprop(self, h, igrads, first_layer=False):
        deltas = (h > 0)*igrads
        ___, ograds = super(Relu, self).bprop(h=None, igrads=deltas, first_layer=first_layer)
        return deltas, ograds
...
class Tanh(Linear):
    ...
    def bprop(self, h, igrads, first_layer=False):
        ...
        ___, ograds = super(Tanh, self).bprop(h=None, igrads=deltas, first_layer=first_layer)
        return deltas, ograds
...
class Maxout(Linear):
    ...
    def bprop(self, h, igrads, first_layer=False):
        ...
        ___, ograds = super(Maxout, self).bprop(h=None, igrads=deltas, first_layer=first_layer)
        return deltas, ograds
