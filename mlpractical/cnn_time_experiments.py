...
tsk8_1_1_cost, tsk8_1_1_accuracy = optimiser.validate(tsk8_1_1_model, test_dp)
logger.info('MNIST test set accuracy is %.2f %% (cost is %.3f)'%(tsk8_1_1_accuracy*100., tsk8_1_1_cost))
